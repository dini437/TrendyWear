							...
							function($http, $q) {
								return {
									...
									deleteFromCart : function(item) {
										return $http
												.post(
														'http://localhost:8080/TrendyWear/flows/deleteFromCart/',
														item)
												.then(
														function(response) {
									...
									fetchAllItems : function(item) {
										return $http
												.post(
														'http://localhost:8080/TrendyWear/flows/fetchAllItems/')
												.then(
														function(response) {
															return response.data;
														},
														function(errResponse) {
															console
																	.error('Error while gettin cart data');
															return $q
																	.reject(errResponse);
														});
									}
...
<body ng-app="myApp" ng-controller="page1">
	...
	<div class="container">
		<a href="${flowExecutionUrl}&_eventId=goToCheckout"
			class="btn btn-primary btn-lg btn pull-right">Current Cart <span
			class="glyphicon glyphicon-chevron-right"></span></a> <a
			href="${pageContext.request.contextPath}/product"
			class="btn btn-success btn-lg btn pull-left"> <span
			class="glyphicon glyphicon-chevron-left"></span>Back to Products
		</a>
	</div>
	<br>
				...
				<div class="col-sm-6">
					<div class="panel panel-primary" style="margin: auto; width: 85%;">
						...
						<div class="panel-body">
							...
							<img style="height: 280; width: 380;"
								src="${pageContext.request.contextPath}/{{x.ProductImage}}"
							...
							<table class="table" style="margin: auto; width: 85%;">
								...
								<tr>
									...
									<td><input type="button" value="Delete from Cart"
										class="btn btn-danger" ng-click="delFromCart(x.CartId)" /></td>
								</tr>
