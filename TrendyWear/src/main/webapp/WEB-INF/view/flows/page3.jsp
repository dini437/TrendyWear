...
'use strict';
    ...
    return {
    	...
    	fetchAllItems: function(){
                return $http.post('http://localhost:8080/TrendyWear/flows/fetchAllItems/')
                        .then(
                                function(response){
...
<body ng-app="myApp" ng-controller="page3">
	...
	<div class="container">
		<a href="${flowExecutionUrl}&_eventId=ConfirmOrder"
			class="btn btn-primary btn-lg btn pull-right">Confirm Order <span
			class="glyphicon glyphicon-chevron-right"></span></a> <a
			href="${flowExecutionUrl}&_eventId=BackToConfirmDetails"
			class="btn btn-success btn-lg btn pull-left"> <span
			class="glyphicon glyphicon-chevron-left"></span>Back To Confirm
			Details
		</a>
	</div>
	<br>
	...
	<div class="row" style="margin: auto; width: 45%;">
		<div class="col-xs-12 col-md-12">
			...
			<br>
			<textarea rows="5" placeholder="Billing address" class="form-control"
				style="resize: none;" ng-model="billingAddress">
	</textarea>
	...
	<div class="panel panel-primary">
		<div class="panel-heading" align="center">
			<h4 style="font-family: Perpetua Titling MT">Products You Choose
				to Buy</h4>
		</div>
	</div>
					...
					<div class="panel panel-primary">
						...
						<div class="panel-body">
							<table class="table" align="center">
								<br>
								<h4 align="center" style="font-weight: bold;">Product
									details</h4>
