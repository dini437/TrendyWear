							...
							function($http, $q) {
								...
								return {
									getUserAddress : function() {
										return $http
												.post(
														'http://localhost:8080/TrendyWear/flows/getUserAddress/')
												.then(
														function(response) {
									...
									updateAddresses : function(item) {
										return $http
												.post(
														'http://localhost:8080/TrendyWear/flows/updateAddresses/',
														item)
												.then(
														function(response) {
															return response.data;
...
<body ng-app="myApp" ng-controller="page2">
	...
	<div class="container">
		<a href="${flowExecutionUrl}&_eventId=ViewCompleteOrder"
			class="btn btn-primary btn-lg btn pull-right">View Complete Order
			<span class="glyphicon glyphicon-chevron-right"></span>
		</a> <a href="${flowExecutionUrl}&_eventId=BackToCart"
			class="btn btn-success btn-lg btn pull-left"> <span
			class="glyphicon glyphicon-chevron-left"></span>Back To Cart
		</a>
	</div>
	<br>
	...
	<form>
		...
		<br>
		<br>
		<br> <input type="button" value="Update" class="btn btn-success"
			ng-click="UpdateAddresses()"
			ng-disabled="shippingAddress=='' || billingAddress==''"> <label
			class="alert alert-success" ng-show="updated=='updated'">Updated</label>
		<br>
		<br>
		<br>
		<br>
