				...
				<div class="col-lg-12 col-centered">
					<div class="table-responsive">
						...
						<form:form method="post"
							action="${pageContext.request.contextPath}/UpdateProductToDB"
							...
							<table style="width: 80%;" class="table center">
								...
								<tr>
									...
									<td><form:select path="productCategory"
											class="form-control select-menu">

											<c:if test="${not empty Categories}">
												<c:forEach var="cat" items="${Categories}">
													<c:choose>
														<c:when
															test="${cat.categoryName == Product.productCategory}">
								...
								<tr>
									...
									<td><form:input path="productPrice" type="productPrice"
											class="form-control" id="productPrice" autofocus="true" /></td>
									<td class="alert alert-danger"><form:errors
											path="productPrice" /></td>
								</tr>


								<tr>
									<td><form:label path="productQuantity"
											for="productQuantity">Product Quantity:</form:label></td>
									<td><form:input path="productQuantity"
											type="productQuantity" class="form-control"
											id="productQuantity" /></td>
									<td class="alert alert-danger"><form:errors
											path="productQuantity" /></td>
								</tr>
								...
								<tr>
									...
									<td><form:textarea path="productDescription"
											class="form-control" id="productDescription"></form:textarea></td>
									<td class="alert alert-danger"><form:errors
