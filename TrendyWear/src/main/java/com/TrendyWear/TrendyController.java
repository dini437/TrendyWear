...
import com.TrendyWear.cart.Cart;
import com.TrendyWear.cart.CartService;
import com.TrendyWear.category.Category;
import com.TrendyWear.category.CategoryService;
import com.TrendyWear.product.Product;
import com.TrendyWear.product.ProductService;
import com.TrendyWear.user.User;
import com.TrendyWear.user.UserService;
import com.TrendyWear.userrole.UserRole;
import com.TrendyWear.userrole.UserRoleDAO;
import com.TrendyWear.userrole.UserRoleService;
...
//
	...
	public ModelAndView category(){
		...
		for (Category c1 : list)
		{
			...
			jobj.put("CategoryImage", c1.getCategoryImage());
	...
	public ModelAndView AddCategoryToDB(@ModelAttribute("Category") Category c, BindingResult bind) {
		...
		try
		{
	        ...
	        if (c.getCategoryFile().getContentType().contains("image"))
	        {
	        	directory = new File(path + "/resources/images");
	        	...
	        	byte[] bytes = null;
	            File file = null;
	            bytes = c.getCategoryFile().getBytes();
	            
	            if (!directory.exists()) directory.mkdirs();
	            
	         
	            
	            file = new File(directory.getAbsolutePath() + System.getProperty("file.separator") + "image_" + ci.getId() + ".jpg");
	            ...
	            ci.setCategoryImage("resources/images/image_" + ci.getId() + ".jpg");
